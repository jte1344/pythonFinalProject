'''
This is a tutorial I am running in order to get a better understanding on how to effectively
parse flight information from a travel site. Once completed and understood, I will personalize
it and rework it to run on various different sites.
'''
...
# Figure out if I can convert this to bs4/beautiful soup
# This would make it work more in line with what we learned in class
...
if __name__ == "__main__":
    ...
    # Change this main into a function that accepts the args rather than collects them from the terminal line
    # This will help when I run the program through a double loop in order to get the full range of dates.
